                       ...
                       <div class="txt-center">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                ...
                                <br/>
                                    ${order.cart.customer.shippingAddress.city}, ${order.cart.customer.shippingAddress.province}
                                <br/>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    ...
                                    <br/>
                                        ${order.cart.customer.billingAddress.city}, ${order.cart.customer.billingAddress.province}
                                    <br/>
